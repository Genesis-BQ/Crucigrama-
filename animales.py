...
class Crucigrama:
    ...
    def mostrar_crucigrama(self):
        ventana = tk.Tk()
        ventana.title('Crucigrama de Animales')
        ancho_ventana = 900
        alto_ventana = 600
        ...
        label_pregunta1 = tk.Label(adivinar_frame, text='¿Como se llama el animal que es el rey de la selva?')
        label_pregunta1.grid(row=7, column=0, columnspan=2)
        label_pregunta2 = tk.Label(adivinar_frame, text='¿Es un animal que posee rapidez y tiene manchas en su pelaje?')
        label_pregunta2.grid(row=8, column=0, columnspan=2)
        label_pregunta3 = tk.Label(adivinar_frame, text='¿Cual es el animal que es un mamifero adaptado al mundo acuatico?')
        label_pregunta3.grid(row=9, column=0, columnspan=2)
        label_pregunta4 = tk.Label(adivinar_frame, text='¿Es una ave grande y no vuela pero posee un gran velocidad y tiene un cuello largo?')
        label_pregunta4.grid(row=10, column=0, columnspan=2)
        label_pregunta5 = tk.Label(adivinar_frame, text='¿Como se llama el animal que se utiliza para los rodeos?')
