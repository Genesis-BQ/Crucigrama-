...
class Crucigrama:
    ...
    def mostrar_crucigrama(self):
        global ventana
        ventana = tk.Tk()
        ventana.title('Crucigrama de Deportes')
        ancho_ventana = 900
        alto_ventana = 600
        ...
        label_pregunta1 = tk.Label(adivinar_frame, text='¿Cual es el deporte que se utiliza una bicicleta para recorer circuitos al aire libre o en pista?')
        label_pregunta1.grid(row=7, column=0, columnspan=2)
        label_pregunta2 = tk.Label(adivinar_frame, text='¿Es un arte marcial basado en estilos marciales chinos?')
        label_pregunta2.grid(row=8, column=0, columnspan=2)
        label_pregunta3 = tk.Label(adivinar_frame, text='¿Cual es el deporte que se reune 32 paises en un mundial, cada 4 años?')
        label_pregunta3.grid(row=9, column=0, columnspan=2)
        label_pregunta4 = tk.Label(adivinar_frame, text='¿Uno de los exponentes de este deporte en Costa Rica es Nery Brenes?')
        label_pregunta4.grid(row=10, column=0, columnspan=2)
        label_pregunta5 = tk.Label(adivinar_frame, text='¿Cual es el deporte donde uno de los equipos más importantes son los Yankees de Nueva York?')
...
if __name__ == '__main__':
    palabras = leer_palabras('deportes.txt')
